...
CSV_FILE_PATH = "C:\Pablo\PythonCourse\CA1CSys-Des\data\historico_lista_combos.csv"
...
def insert_values_to_table(table_name, csv_file):
    ...
    if conn is not None:
        ...
        names_price = ["codigo_lista", "codigo_combo", "sku", "nombre_producto", "cantidad_en_kg", "frigorifico_sin_iva", "frigorifico_con_iva", "ca1c_sin_iva", "ca1c_con_iva"]
        dict_price_lst = {"codigo_lista": int, "codigo_combo": int, "sku": int, "nombre_producto": str, "cantidad_en_kg": float, "frigorifico_sin_iva": float, "frigorifico_con_iva": float, "ca1c_sin_iva": float, "ca1c_con_iva": float}
...
if __name__ == "__main__":
    insert_values_to_table("combo_values", CSV_FILE_PATH)
